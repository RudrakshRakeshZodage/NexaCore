      ...
      >
        <Card className="border-blue-200/30 shadow-xl bg-white/95 dark:bg-gray-900/95 backdrop-blur">
          <CardHeader className="space-y-1">
            <CardTitle className="text-2xl font-bold text-center text-gray-900 dark:text-white">Corporate Login</CardTitle>
          ...
          <CardFooter className="flex flex-col space-y-4">
            <div className="text-sm text-center text-gray-700 dark:text-gray-300">
              ...
              <Link to="/signup/corporate" className="text-blue-600 hover:underline">
                Create an account
              </Link>
            </div>
            <div className="text-sm text-center text-gray-700 dark:text-gray-300">
