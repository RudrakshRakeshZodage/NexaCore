...
const Education = () => {
  ...
  // Handle adding a new completed course
  ...
  const generateRecommendations = () => {
    // In a real app, this would call an API with GPT to generate recommendations
    // For now, we'll just show a toast and use the mock data
    toast({
  ...
  const saveEducationDetails = () => {
    // Here we would save all education details to a backend or local storage
    toast({
      title: "Education Details Saved",
      description: "Your education details have been successfully saved.",
    });
  };
